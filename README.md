# Introduction to CAP Technologies Linux Tests

If you prefer reading over listening to podcasts, this is the short, readable introduction to our Linux testing series.

## Why this series exists
Linux is a practical alternative for many desktop and laptop users today. With more polished desktop experiences, broader community support, and lightweight options for older hardware, switching from Windows or macOS is easier than it used to be. This series documents hands‑on tests and guides aimed at people who are curious about making that move or who need to evaluate Linux for real‑world use.
